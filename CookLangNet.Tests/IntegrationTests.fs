    ...
    let tikkaMasalaRecipe = {
        ...
        Steps = [
            { 
                ...
                Cookware = [ { Quantity = Numeric 1; Name = "tofu press" } ; { Name = "large bowl"; Quantity = Numeric 1 } ]
            ...
            }
            {
                ...
                Cookware = [ { Quantity = Numeric 1; Name = "frying pan" } ]
                Timers = []
            }
            { 
            ...
            }
            {
                ...
                Cookware = [ { Quantity = Numeric 1; Name = "spice grinder" } ; { Name = "mortar"; Quantity = Numeric 1 } ]
                Timers = []
            }
            {
            ...
            }
            {
                ...
                Ingredients = []
                Cookware = [ { Quantity = Numeric 1; Name = "oven" } ; { Name = "12-inch cast iron skillet"; Quantity = Numeric 1 } ]
                Timers = []
            }
            {
                Directions = "Once the skillet is smoking hot, transfer it to the stove or a pot holder. Turn the broiler to high."
                Ingredients = []
                Cookware = [ { Quantity = Numeric 1; Name = "broiler" } ]
                Timers = []
            }
            {
            ...
            }
            {
                ...
                Cookware = [ { Quantity = Numeric 1; Name = "12-inch sauté pan" } ]
            ...
            }
            {
                ...
                Ingredients = []
                Cookware = [ { Quantity = Numeric 1; Name = "immersion blender" } ]
                Timers = []
            }
            {
                ...
                Ingredients = [ { Name = "lemon juice" ; Amount = None } ; { Name = "sugar" ; Amount = Some { Quantity = Numeric 0.5 ; Unit = Some "teaspoon" } } ]
                Cookware = []
                Timers = []
            }
            {
