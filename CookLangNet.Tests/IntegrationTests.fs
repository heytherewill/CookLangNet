    ...
    let tikkaMasalaRecipe = {
        ...
        Steps = [
            ...
            }
            {
                ...
                NeededEquipment = [ { Name = "spice grinder" } ; { Name = "mortar" } ]
                Timers = []
                Comment = ""
            }
            {
            ...
            }
            {
                ...
                Ingredients = []
                NeededEquipment = [ { Name = "oven" } ; { Name = "12-inch cast iron skillet" } ]
                Timers = []
                Comment = ""
            }
            {
            ...
            }
            {
                ...
                NeededEquipment = [ { Name = "12-inch sauté pan" } ]
            ...
            }
            {
                ...
                Ingredients = []
                NeededEquipment = [ { Name = "immersion blender" } ]
                Timers = []
                Comment = ""
            }
            {
