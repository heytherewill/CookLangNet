    ...
    let tikkaMasalaRecipe = {
        ...
        Steps = [
            { 
                ...
                Cookware = [ { Quantity = None; Name = "tofu press" } ; { Name = "large bowl"; Quantity = None } ]
            ...
            }
            {
                ...
                Cookware = [ { Quantity = None; Name = "frying pan" } ]
                Timers = []
                //Comment = ""
            }
            { 
            ...
            }
            {
                ...
                Cookware = [ { Quantity = None; Name = "spice grinder" } ; { Name = "mortar"; Quantity = None } ]
                Timers = []
                //Comment = ""
            }
            {
            ...
            }
            {
                ...
                Ingredients = []
                Cookware = [ { Quantity = None; Name = "oven" } ; { Name = "12-inch cast iron skillet"; Quantity = None } ]
                Timers = []
                //Comment = ""
            }
            {
                ...
                Ingredients = []
                Cookware = [ { Quantity = None; Name = "broiler" } ]
                Timers = []
                //Comment = ""
            }
            {
            ...
            }
            {
                ...
                Cookware = [ { Quantity = None; Name = "12-inch sauté pan" } ]
            ...
            }
            {
                ...
                Ingredients = []
                Cookware = [ { Quantity = None; Name = "immersion blender" } ]
                Timers = []
                //Comment = ""
            }
            {
